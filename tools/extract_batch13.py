"""Batch 13: distance + facilityname + helpertooltips + multipart + newslettersignup + powered + saveload + foliagebrush."""
import json
...
EXACT = [
    ...
    ("helpertooltips_", "helpertooltips"),
    ("multipart_", "multipart"),
    ("newslettersignup_", "newslettersignup"),
    ("powered_", "powered"),
    ("saveload_", "saveload"),
    ("foliagebrush_", "foliagebrush"),
]
...
Path("../translations/batch13_source.json").write_text(
    json.dumps(out, ensure_ascii=False, indent=2), encoding="utf-8"
)
print("Yazildi: translations/batch13_source.json")
