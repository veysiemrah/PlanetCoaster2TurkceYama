"""Batch 2: coastereditor, train, station, ridecam, sequencer."""
import json
from pathlib import Path

PREFIXES = ["coastereditor", "train", "station", "ridecam", "sequencer"]
...
Path("../translations/batch2_source.json").write_text(
