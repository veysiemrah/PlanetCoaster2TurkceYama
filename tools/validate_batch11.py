"""Sadece batch11'de yer alan anahtarlari validate eder."""
import json
import sys
...
batch = json.loads(Path("../translations/batch11_translated.json").read_text(encoding="utf-8"))
...
print(f"Batch11 anahtar sayisi: {len(batch_keys)}")
