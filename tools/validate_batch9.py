"""Sadece batch9'da yer alan anahtarlari validate eder."""
import json
import sys
...
batch = json.loads(Path("../translations/batch9_translated.json").read_text(encoding="utf-8"))
...
print(f"Batch9 anahtar sayisi: {len(batch_keys)}")
