"""Sadece batch12'de yer alan anahtarlari validate eder."""
import json
import sys
...
batch = json.loads(Path("../translations/batch12_translated.json").read_text(encoding="utf-8"))
...
print(f"Batch12 anahtar sayisi: {len(batch_keys)}")
