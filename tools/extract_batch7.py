"""Batch 7: toolpanelfoliagescenery + credits + pathresource pending."""
import json
...
prefixes = ["toolpanelfoliagescenery", "credits", "pathresource"]
...
Path("../translations/batch7_source.json").write_text(
    json.dumps(out, ensure_ascii=False, indent=2), encoding="utf-8"
)
print("Yazildi: translations/batch7_source.json")
