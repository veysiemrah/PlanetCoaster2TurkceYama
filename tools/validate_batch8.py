"""Sadece batch8'de yer alan anahtarlari validate eder."""
import json
import sys
...
batch = json.loads(Path("../translations/batch8_translated.json").read_text(encoding="utf-8"))
...
print(f"Batch8 anahtar sayisi: {len(batch_keys)}")
