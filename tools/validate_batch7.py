"""Sadece batch7'de yer alan anahtarlari validate eder."""
import json
import sys
...
batch = json.loads(Path("../translations/batch7_translated.json").read_text(encoding="utf-8"))
...
print(f"Batch7 anahtar sayisi: {len(batch_keys)}")
