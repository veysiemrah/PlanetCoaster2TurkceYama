"""Sadece batch6'da yer alan anahtarlari validate eder."""
import json
import sys
...
batch = json.loads(Path("../translations/batch6_translated.json").read_text(encoding="utf-8"))
...
print(f"Batch6 anahtar sayisi: {len(batch_keys)}")
